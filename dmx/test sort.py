...
#     # cuedict sortieren nach Nummer:
#     cuedict = sorted (cuedict.items(), key=lambda x: x[1][0])
...
cuedict = {'fieldnames': ['Nummer', 'Text', 'Filename', 'Level'],
 ...
 2: ['2', 'grün', 'grün', '0.0314']
}


# sortlist = [(0, ['1', 'rot', 'rot', '0.2275']),
#  (2, ['2', 'grün', 'grün', '0.0314']),
#  (1, ['3', 'blau', 'blau', '0.0706']),
#  ('fieldnames', ['Nummer', 'Text', 'Filename', 'Level'])
# ]
dictlist = [
...
# sortlist = sorted (dictlist, key=lambda x: int (x["Name"]))
